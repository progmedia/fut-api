<?php
	...
	class Functionor {
		...
		public function playerinfo($id){
            	$playerurl = "http://cdn.content.easports.com/fifa/fltOnlineAssets/".$this->key."/2014/fut/items/web/". $id .".json";
    	...
    	public function playerimage($id){
            	$pic = "http://cdn.content.easports.com/fifa/fltOnlineAssets/".$this->key."/2014/fut/items/images/players/web/".$id.".png";
            	return $pic;
    	}
